...
import org.TestLeaf.Design.Browser;
import org.TestLeaf.Design.Element;

public class SeleniumBase implements Browser, Element{

	public static RemoteWebDriver driver = (RemoteWebDriver) SeleniumDriver.getDriver();
...
//		strDate = strDate.substring(0,8);
		String sName = SeleniumDriver.getScenarioName();
		String strDate = SeleniumDriver.getScreenshotsPath();
		try {
			FileUtils.copyFile(driver.getScreenshotAs(OutputType.FILE) , new File("./reports/images/"+sName+"_"+strDate+"/"+number+".jpg"));		
		} catch (WebDriverException e) {
